...
//Last modified: Fri, Feb 21, 2014 12:42:15 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -79.31001574410989 0.64234839169584257 23.945791841813474 ;
	setAttr ".r" -type "double3" 356.06164726480358 644.59999999988179 1.5772219914276415e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 82.150453815989408;
...
select -ne :defaultRenderGlobals;
	setAttr ".ifp" -type "string" "tempuv";
