...
//Last modified: Wed, Jan 22, 2014 11:01:03 AM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.416489162591713 3.3478621330897482 -69.819689269942174 ;
	setAttr ".r" -type "double3" -6.3383527297057656 166.59999999996876 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 75.614949775203229;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 10 ".pt";
	setAttr ".pt[0]" -type "float3" -1.0507662 0 0.33829939 ;
	setAttr ".pt[1]" -type "float3" -0.88835853 0 0.33829939 ;
	setAttr ".pt[2]" -type "float3" -0.71396804 0 0 ;
	setAttr ".pt[15]" -type "float3" -0.23919448 0 -0.41098401 ;
	setAttr ".pt[16]" -type "float3" -0.23919448 0 -0.41098401 ;
	setAttr ".pt[17]" -type "float3" -0.90617663 0 -0.20626244 ;
	setAttr ".pt[18]" -type "float3" -0.90617663 0 -0.20626244 ;
	setAttr ".pt[19]" -type "float3" -0.87637562 0 0 ;
