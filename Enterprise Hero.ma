...
//Last modified: Thu, Jan 23, 2014 10:03:05 AM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.038700589269749 1.1237750509345368 -57.518476111438417 ;
	setAttr ".r" -type "double3" 354.26164726823441 543.79999999965264 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 61.246448007634143;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.82676815790198344 -2.4000296730824804 0.0917005401549007 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 2.8182686969306046 0.465813534091569 0.069055045654440761 ;
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 10.046601157780323 1.9166784370096162 0.1811344994972961 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" -2.4449162849759802 0.29745963416976307 1.4609671872483858 ;
	setAttr ".r" -type "double3" 19.916006208317807 0 0 ;
	setAttr ".s" -type "double3" 1 0.76162404681233209 1 ;
...
createNode transform -n "pasted__pCube3" -p "group";
	setAttr ".t" -type "double3" -2.5003688206627954 0.29745963416976301 -1.2722133502148865 ;
	setAttr ".r" -type "double3" -18.875312191470531 0 0 ;
	setAttr ".s" -type "double3" 1 0.76162404681233209 1 ;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" -8.2166879565993032 2.9874775595885081 -6.8211565948324644 ;
...
createNode mesh -n "pCubeShape4" -p "pCube4";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 36 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0.24057131 -0.21314509 ;
	setAttr ".pt[2]" -type "float3" 0 -0.24057131 -0.21314509 ;
	setAttr ".pt[4]" -type "float3" 0 -0.24057131 0.21314509 ;
	setAttr ".pt[6]" -type "float3" 0 0.24057131 0.21314509 ;
	setAttr ".pt[8]" -type "float3" 0 -0.30221653 0.091375321 ;
	setAttr ".pt[9]" -type "float3" 0 0.30221653 0.091375321 ;
	setAttr ".pt[12]" -type "float3" 0 -0.29622141 -0.10372181 ;
	setAttr ".pt[13]" -type "float3" 0 0.29622141 -0.10372181 ;
	setAttr ".pt[16]" -type "float3" 0 -0.061544981 0.24779525 ;
	setAttr ".pt[19]" -type "float3" 0 -0.061544981 -0.24779525 ;
	setAttr ".pt[24]" -type "float3" 0 0.12780508 0.24779525 ;
	setAttr ".pt[27]" -type "float3" 0 0.12780508 -0.24779525 ;
