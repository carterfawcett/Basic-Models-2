...
//Name: Ent. Scene
//Last modified: Fri, Jan 31, 2014 01:29:46 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -89.226162749863406 -2.5589126972978309 20.63088923184365 ;
	setAttr ".r" -type "double3" 358.46164726510818 641.00000000005184 -5.2089962320240738e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 90.928954356384196;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.82676815790198344 -2.4000296730824804 0.17955432952408579 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 2.8182686969306046 0.465813534091569 0.15690883502362585 ;
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 10.046601157780323 1.9166784370096162 0.26898828886648118 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" -2.6094502103310044 0.04924531416631435 2.4810298110823981 ;
	setAttr ".r" -type "double3" 33.09810906341523 -2.1435648732997024 1.0146500344003455 ;
...
createNode transform -n "pasted__pCube3" -p "group";
	setAttr ".t" -type "double3" -2.6649027460178196 -0.0098006891484989506 -2.0933699722329431 ;
	setAttr ".r" -type "double3" -34.506452507015723 0 0 ;
...
createNode transform -n "pasted__pCube4" -p "group1";
	setAttr ".t" -type "double3" -8.216687956599305 2.8443598298293025 3.7159604901115264 ;
...
createNode transform -n "pasted__pasted__pCube4" -p "pasted__group1";
	setAttr ".t" -type "double3" -8.2166879565993032 2.844359829829302 -3.4766486602960391 ;
	setAttr ".s" -type "double3" 0.94640010779917583 0.60484472027365244 0.45581798392529932 ;
...
createNode imagePlane -n "imagePlaneShape1" -p "imagePlane1";
	setAttr -k off ".v";
	setAttr ".fc" 51;
	setAttr ".imn" -type "string" "/Users/carterfawcett/MayaModeling/pic.png";
	setAttr ".cov" -type "short2" 2582 1936 ;
